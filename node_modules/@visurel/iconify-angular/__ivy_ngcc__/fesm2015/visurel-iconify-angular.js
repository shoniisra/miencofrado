...
IconDirective.ɵfac = function IconDirective_Factory(t) { return new (t || IconDirective)(ɵngcc0.ɵɵdirectiveInject(ɵngcc1.DomSanitizer)); };
IconDirective.ɵdir = ɵngcc0.ɵɵdefineDirective({ type: IconDirective, selectors: [["ic-icon"], ["", "icIcon", ""]], hostVars: 5, hostBindings: function IconDirective_HostBindings(rf, ctx) { if (rf & 2) {
        ɵngcc0.ɵɵhostProperty("innerHTML", ctx.iconHTML, ɵngcc0.ɵɵsanitizeHtml);
        ɵngcc0.ɵɵstyleProp("font-size", ctx.size);
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(IconDirective, [{
    ...
    }], function () { return [{ type: ɵngcc1.DomSanitizer }]; }, { width: [{
            type: Input
        }], height: [{
            type: Input
        }], rotate: [{
...
export { IconDirective, IconModule };
